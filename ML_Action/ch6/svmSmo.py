...
def smoSimple(dataMatIn, classLabels, C, toler, maxIter):
    ...
    while (iter_ < maxIter):
        ...
        for i in range (m):
            #print(alphas)
            #print('***')
            #print(dataMatrix * dataMatrix[i, :].T)
            #print('***')
            ...
            if ((labelMat[i]*Ei < -toler) and (alphas[i] < C)) or ((labelMat[i]*Ei > toler) and (alphas[i] > 0)):
                ...
                #print(dataMatrix * dataMatrix[j, :].T)
                ...
                if (0 < alphas[i]) and (C > alphas[i]):
                    ...
                    b = (b1 + b2)/2.0
                alphaPairsChanged += 1
                print('iter', iter_, 'i', i, 'pairs changed', alphaPairsChanged)
...
def kernelTrans(X, A, kTup):
    ...
    if kTup[0] == 'lin':
        ...
        raise NameError('problem : that kernel is not recognized')
    return K 
...
class optStruct:
    def __init__(self,dataMatIn, classLabels, C, toler, kTup):  # Initialize the structure with the parameters 
        ...
        self.alphas = mat(zeros((self.m))).T
        self.b = 0
...
def testRbf(k1=1.3):
    ...
    for i in range(m):
        #print(sVs)
        #print(kernelTrans(sVs,datMat[i,:],('rbf', k1)))
